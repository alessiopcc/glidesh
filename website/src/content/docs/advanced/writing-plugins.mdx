...
1. **Describe** — glidesh probes the plugin during discovery to learn its name and version. This happens once at startup in a short-lived process — not during task execution.
